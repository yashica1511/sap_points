  ...
  <div className="relative overflow-hidden custom-container">
    ...
    <div>
      <div className="bg-purple-300 p-8 rounded-lg w-30">
        <h2 className="flex justify-center items-center font-['Inknut_Antiqua'] text-[26px] font-semibold leading-[30px] text-[#fff] relative text-center mb-6 text-black">PATENT/ COPYRIGHT</h2>
        <div className="mb-6">
          <select className="flex justify-center items-center border rounded items-center px-4 py-2 w-full custom-select mx-auto">
          <option value="" disabled selected style={{ display: "none" }}>Patent/Copyright</option>
          <option value="pat">Patent</option>
                    <option value="cop">Copyright</option>
          </select>
        </div>
        <div className="mb-4">
          ...
          <option value="in">Applied</option>
                    <option value="pub">Published</option>
                    <option value="obt">Obtained</option>
          </select>
        </div>
        <div className="mb-4">
