  ...
  <div className="relative overflow-hidden custom-container">
    ...
    <div>
      <div className="bg-purple-300 p-8 rounded-lg w-30">
        <h2 className="flex justify-center items-center font-['Inknut_Antiqua'] text-[26px] font-semibold leading-[30px] text-[#fff] relative text-center mb-6 text-black">VAC/ ONLINE COURSES</h2>
        <div className="mb-6">
          <select className="flex justify-center items-center border rounded items-center px-4 py-2 w-full custom-select mx-auto">
          <option value="" disabled selected style={{ display: "none" }}>Courses</option>
          <option value="vac">Value Added Course(Non-credit course)</option>
        <option value="nptel">Physical(Industry collaboration)/ Online Courses (NPTEL etc..)</option>
          </select>
        </div>
        <div className="mb-4">
          <select className="flex justify-center items-center border rounded px-4 py-2 w-full custom-select mx-auto">
          <option value="" disabled selected style={{ display: "none" }}>Credits</option>
          <option value="one">One Credit</option>
            <option value="two">Two Credits</option>
            <option value="three">More than two Credits</option>
          </select>
        </div>
        <div className="mb-4">
