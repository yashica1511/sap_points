  ...
  <div className="relative overflow-hidden custom-container">
    ...
    <div>
      <div className="bg-purple-300 p-8 rounded-lg w-30">
        <h2 className="flex justify-center items-center font-['Inknut_Antiqua'] text-[26px] font-semibold leading-[30px] text-[#fff] relative text-center mb-8 text-black">LEADERSHIP / ORGANIZING EVENTS</h2>
        <div className="mb-8">
          ...
          <option value="chair">Chairman/Secretary/Treasurer etc..</option>
            <option value="joint">Joint Secretary/Vice Chairman etc..</option>
            <option value="ec">EC Memeber</option>
            <option value="rep">Class Rep/Placement or Cell Coordinator</option>
            <option value="iv">IV or IPT Coordinator</option>
          </select>
        </div>
        <div className="mb-4">
        <div className="font-['Inknut_Antiqua'] text-[26px] font-semibold leading-[30px] text-[#fff] absolute top-[213px] left-[100px] w-[102px] h-[36px] text-black">
