  ...
  return (
    ...
    <div className='main-container absolute top-[40px] left-[80px] w-[1356px] h-[1440px] bg-[rgba(255,255,255,0.85)] border-2 border-[#BCC1CAFF] rounded border-solid pb-10'>
      ...
      <div className='w-[224px] h-[248px] bg-[rgba(131,83,226,0.74)] rounded-[8px] absolute top-px left-0 shadow-[0_17px_35px_0_rgba(23,26,31,0.24)] z-[1]'>
          ...
          <span className="flex w-[224px] h-[103px] justify-center items-center font-['Inknut_Antiqua'] text-[18px] font-semibold leading-[30px] text-[#fff] relative text-center z-[28] mt-[-9px] mr-0 mb-0 ml-0"> 
      ...
      <div className='w-[225px] h-[149px] bg-[url(../../images/Membership.jpg)] bg-cover bg-no-repeat rounded-[8px] relative z-[15] mt-px mr-0 mb-0 ml-0' />
          <span className="flex w-[225px] h-[97px] justify-center items-center font-['Inknut_Antiqua'] text-[18px] font-semibold leading-[30px] text-[#fff] relative text-center z-[33] mt-px mr-0 mb-0 ml-[-1px]">
            5.MEMBERSHIP
          </span>
        </div>
