  ...
  <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center">
    <div className="bg-[#D9CBF6] p-4 rounded flex flex-col relative">
      ...
      <div className="flex ">
        ...
        <button className='w-122 h-36 bg-#8353e2 rounded-4 border-none relative overflow-hidden'>
      ...
      <div className='absolute top-0 left-0'>
        <div className='w-147 h-137 bg-[url(../../images/01cbb6f67f-66a6-4338-9af0-360beb32d5bb.png)] bg-cover bg-no-repeat' />
      </div>
      <div className='absolute top-[317px] left-[-49px]'>
        <div className='w-178 h-179 bg-[url(../../images/01/daaccf65-dbb1-4c81-9a55-e9c8330d2a12.png)] bg-cover bg-no-repeat' />
      </div>
    </div>
  </div>
)}
